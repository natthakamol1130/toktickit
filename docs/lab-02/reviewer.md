...
| #4 | `feature/4-reference-data-api` | Implemented GET /api/requesters, GET /api/categories, and GET /api/related-systems | Approved. Reference APIs return active records with consistent payload format. | Approved |
