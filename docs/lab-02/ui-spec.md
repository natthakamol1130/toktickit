# Lab 2 UI Specification: Sakura Rose Pink Theme (Zen Green Architecture Compatible)

## 1. Visual Design Tokens (Sakura Rose Pink Palette)

> **Architectural Note**: The CSS custom properties retain the `--zg-` prefix to maintain 100% compatibility with the base Zen Green component architecture and test assertions, while adopting the customized Sakura Rose Pink visual color palette.
